var jsPsychIatImage = (function (jspsych) {
  ...
  class IatImagePlugin {
      ...
      trial(display_element, trial) {
          var html_str = "";
          html_str +=
              "<div style='position: absolute; height: 20%; width: 100%; margin-left: auto; margin-right: auto; top: 29%; left: 0; right: 0'><img src='" +
                  trial.stimulus +
                  "' id='jspsych-iat-stim'></img></div>";
          html_str += "<div id='trial_left_align' style='position: absolute; top: 5%; left: 20%'>";
          ...
          html_str += "<div id='trial_right_align' style='position: absolute; top: 5%; right: 20%'>";
          ...
          html_str +=
              "<div id='wrongImgID' style='position:relative; top: 225px; margin-left: auto; margin-right: auto; left: 0; right: 0'>";
